...
def valid_one_epoch(
    ...
    if evaluator is not None:
        ...
        if if_save_data:
            np.save(f'/data3/xiaodan8/actionformer/output/pred_{output_file}_ap.npy', np.mean(ap, axis=0))
    else:
    ...
    if if_save_data:
        ...
        with open('/data3/xiaodan8/actionformer/output/pred.json', 'w') as json_file:
