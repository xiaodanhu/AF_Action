...
DEFAULTS = {
    ...
    "model": {
        # type of backbone (convTransformer | conv | ActionFormerWithViT | ActionFormerWithViViT | ActionFormerViViTPrompt | ActionFormerWithTimesformer | ActionFormerWithVideoMAE | ActionFormerWithCLIP)
        "backbone_type": 'ActionFormerWithViT',
