...
def make_dataset(name, is_training, split, backbone_type, round, use_full, **kwargs):
   """
       A simple dataset builder
   """
   dataset = datasets[name](is_training, split, backbone_type, round, use_full, **kwargs)
   return dataset
