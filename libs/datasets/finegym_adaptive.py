...
@register_dataset("finegym_adaptive")
class FineGymDataset(Dataset):
    ...
    def _load_json_db(self, json_file):
        ...
        if 'train' in self.split:
            ...
            with open(f'/data3/xiaodan8/actionformer4_1/output/pred_vit_adaptive_{self.round - 1000}.json') as f:
                pred = json.load(f)
            ...
            for k_item, v_item in video_list_by_cat.items():
                video_list.extend(circ_slice(v_item, 0, (self.round - 1000) // self.num_classes + math.ceil(confuse_score[k_item] * per_round_num)))
            dict_db = video_list
            shuffle(dict_db)
