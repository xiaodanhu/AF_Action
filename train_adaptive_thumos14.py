...
def main(args):
    ...
    pred_folder = '/data3/xiaodan8/actionformer4_1/output/thumos14'
    ...
    for epoch in range(args.start_epoch, max_epochs):
        ...
        if (
            ...
            if mAP > best_mAP:
                ...
                client_sd = {}
                client_sd['epoch'] = epoch
                model_engine.save_checkpoint(ckpt_folder, tag=f'vit_adaptive_{args.round}', client_state=client_sd)
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--resume', default='vit_uniform_1000', type=str, metavar='PATH', help='checkpoint')
    parser.add_argument('--round', default=0, type=int)
    parser.add_argument('--seed', default=42, type=int)
    parser.add_argument('--config', metavar='DIR', default='./configs/thumos_i3d_adaptive.yaml', help='path to a config file')
    parser.add_argument('--output', default='ds', type=str, help='name of exp folder (default: none)')
