    ...
    for epoch in range(args.start_epoch, max_epochs):
        ...
        if (
            ...
            mAP = valid_one_epoch(
                ...
                epoch,
                evaluator=det_eval,
                output_file = 'uniform_' + str(args.round),
                print_freq=args.print_freq,
                best_map=best_mAP,
                if_save_data=True
            )
            ...
            if mAP > best_mAP:
                ...
                client_sd = {}
                client_sd['epoch'] = epoch
                model_engine.save_checkpoint(ckpt_folder, tag=f'vit_uniform_{args.round}', client_state=client_sd)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', metavar='DIR', default='./configs/finegym_i3d_uniform.yaml', help='path to a config file')
